...
all : $(BUILD_DIR)/bits-test $(BUILD_DIR)/position-test $(BUILD_DIR)/moves-test

debug : $(BUILD_DIR)/bits-test $(BUILD_DIR)/position-test $(BUILD_DIR)/moves-test
...
$(BUILD_DIR)/moves-test : $(BUILD_DIR)/moves-test.o $(BUILD_DIR)/moves.o $(BUILD_DIR)/position.o 
